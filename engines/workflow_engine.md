...
2. **Stage 2: Request Analysis**: Deconstruct prompt, parse explicit vs implicit intent, detect ambiguities, estimate complexity and risks.
...
4. **Stage 4: Expert Consultation Matrix**: Internally consult relevant Virtual AI Company specialist roles from `personas/roles.md`.
